...
#           the server
#
rsync -Crtvz --delete-after --exclude="source" --exclude="CVS" --exclude="Thumbs.db" --exclude="*.hsc" --exclude="*.tmp" --exclude="hsc.prefs" --include="*.html" . octopus.pepperfish.net:websites/davespace.co.uk/www/html
