...
#           the server
#
rsync -Crtvz --exclude="CVS" --exclude="Thumbs.db" --exclude="*.hsc" --exclude="*.tmp" --exclude="hsc.prefs" --include="*.html" . octopus.pepperfish.net:websites/davespace.co.uk/www/html
