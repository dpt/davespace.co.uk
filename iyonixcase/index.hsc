...
<masterpage author="David Thomas"
  ...
  <div id="content">
    ...
    <slide title="An Upgrade">
      ...
      the sparse nature of the Iyo<rq>s motherboard, which has no bulky
      heatsinks to get in the way <mdash> quite empty inside. So I thought I
      might try repacking the Iyo into a smaller case.</p> <captionedimage
      url="DSCF2976.JPG" dsc="fnord!">The &lsquo;Panther&rsquo;
      case.</captionedimage>
      ...
      <captionedimage url="DSCF2978.JPG" dsc="fnord!">The case, plus a
      ...
      <p>I wish I'd known about riscos.info's <a
        href="http://www.riscos.info/downloads/documents/IYONIX/IyonixJumpers.pdf">jumpers PDF</a> before starting, as it lists all the connections.</p>

      <captionedimage url="DSCF2943.JPG" dsc="fnord!">The reset connector <ndash> pins 15 and 16 on PL301 <ndash> obviously.</captionedimage>
      ...
      <captionedimage url="DSCF2945.JPG" dsc="fnord!">Motherboard and PCI cards mounted on the tray.</captionedimage>
      ...
      <captionedimage url="DSCF2934.JPG" dsc="fnord!">Interior. Blue card at
      ...
      <captionedimage url="DSCF2933.JPG" dsc="fnord!">PSU, motherboard, drives, installed.</captionedimage>
    </slide>

    <slide title="3.5&rdquo; to 2.5&rdquo; Hard Disc">
      <p>To cut down the hard disc noise I replaced the existing Maxtor 80G
      3.5" IDE hard disc with a Samsung 160G 2.5" unit. The LFAU on the new
      drive is <strong>huge</strong>. :-(</p>
      ...
      <captionedimage url="DSCF2944.JPG" dsc="fnord!">The bay is set up for a
      pair of 3.5" drives, so the 2.5" drive has a mounting bracket fitted.
      This doesn't provide an entirely satisfactory fit.</captionedimage>
    </slide>

    <slide title="Video Card Cooling Noise">
      <p>With the system reassembled it became obvious that the largest
      remaining source of noise was the GeForce card's cooling fan which
      emitted a high-pitched whine.</p>

      <p>I tried running the card with a fanless northbridge heatsink, but it
      was just getting too hot. So I replaced this with a new VGA cooler from
      <a
        href="http://www.quietpc.co.uk">Quiet PC</a>. Unlike the stock cooler
      this can't be powered from the card, so is instead connected up to a
      spare power rail from the PSU.</p>
      <captionedimage url="DSCF2940.JPG" dsc="fnord!">GeForce FX5500 with new
      ...
      <captionedimage url="DSCF2950.JPG" dsc="fnord!">Spare heatsinks were
      mounted on the three major chips.</captionedimage>
    </slide>

    <slide title="Rounded IDE Cables">
      <p>The left-hand front 120mm fan was partly obscured with the IDE and
      floppy cables which join the motherboard at that point. To allow the fan
      to work more effectively, I swapped these for a set of rounded leads.</p>
      <captionedimage url="DSCF2941.JPG" dsc="fnord!">Rounded floppy and IDE
      leads installed.</captionedimage>
      <captionedimage url="DSCF2951.JPG" dsc="fnord!"> I bought 12"? ones but
      with hindsight these are probably a few inches too long.</captionedimage>
    </slide>

    <slide title="Everything Together">
      <captionedimage url="DSCF2942.JPG" dsc="fnord!">Side view
      again.</captionedimage>
      <captionedimage url="DSCF2967.JPG" dsc="fnord!">f685s</captionedimage>
    </slide>
