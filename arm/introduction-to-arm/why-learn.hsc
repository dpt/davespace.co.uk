...
<page heading="Why Learn Assembly?" rev="index" cur="why-learn" fwd="not-trivial">
  ...
  <slide>
    <ul>
      <li>
      Ideally we would never need to write assembly language because it
      requires more effort to code than <abbr title="High Level Languages">HLLs</abbr> like C.
      </li>
      <li>
      ...
      <li>
      Sometimes compilers aren&rsquo;t very good. They may produce unnecessary
      extra code which we call <dfn>slop</dfn>.  Slop increases size and
      decreases speed.
      </li>
      <li>
  ...
  <commentary>
    ...
    <p>The C code you write is <em>not</em> the instructions which the <abbr
      title="Central Processing Unit">CPU</abbr> executes.  It&rsquo;s an
    abstraction which insulates you from the weaknesses and the strengths of
    the machine. We tend to forget this.</p>
