  ...
  <slide>
    ...
    It can take one of three different forms:
      <dl>
        ...
        <dd>&ndash; An 8-bit number rotated right by an even number of places.</dd>
        <dt>Register shifted by value.</dt>
        <dd>&ndash; A 5-bit unsigned integer shift.</dd>
        <dt>Register shifted by register.</dt>
        <dd>&ndash; The bottom 8 bits of a register.</dd>
      </dl>
    </p>
  </slide>
  <footer>
