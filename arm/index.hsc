...
<page cur="index">
  ...
  <article>
    <p>Here are two training courses originally written to introduce my former
    colleagues at <ext url="http://www.picsel.com/">Picsel</ext> to the joys of
    programming in <ext url="http://www.arm.com/">ARM</ext> assembly
    language. They are:</p>
    <dl>
    ...
    Edinburgh, Reading offices), Malaysia (Kuala Lumpur) and Korea (Seoul).</p>
