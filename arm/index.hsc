  ...
  <div id="content">
    ...
    <slide title="Hello">
      ...
      <dl>
        ...
        <dd>The first course introduces the reader to ARM assembly
        language. It goes on to explain the development of the ARM architecture and
        the capabilities of the various ARM CPU cores.</dd>
        <dd>After reading this you should be able to understand ARM code well
        enough to understand the examples in the next course...</dd>
        <dt><a href="efficient-c-for-arm/index.html">Efficient C for ARM</a></dt>
    ...
    <slide title="Some caveats">
      ...
      sacrificed for the sake of making a point.</p>
    ...
    <slide title="Toolchains">
      <p>The courses were written for an environment where the <a
        ...
        Suite</a> (ADS) was available, so all of the assembler examples are in
      ADS format.  If you intend to try the examples on a more affordable
      compiler, such as <a class="external" href="http://gcc.gnu.org/">GCC</a>,
      you will need to use <a class="external"
        href="http://microcross.com/GNU-ARM-Assy-Quick-Ref.pdf">GNU ARM
        assembler syntax</a>.</p>
      <p>Assembler examples were compiled with (the now rather old pair of) ADS
