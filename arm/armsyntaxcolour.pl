...
# ARM mnemonics
$lines =~
s!\b(((MOV)|(MVN)|(ADD)|(ADC)|(SUB)|(SBC)|(RSB)|(RSC)|(AND)|(EOR)|(ORR)|(BIC)|(CMP)|(CMN)|(TST)|(TEQ)|(B)|(BL)|(BX)|(MUL)|(MLA)|(UMULL)|(UMLAL)|(SMULL)|(SMLAL)|(LDR)|(STR)|(LDM)|(STM)|(ADR))[A-Z]*)\b!<span class="keyword">$1</span>!g;
